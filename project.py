...
class App(QWidget):
    ...
    def initUI(self):
        self.setWindowTitle('Mudanyali Çok Fonksiyonlu Uygulama - Türkçe' if self.language == 'Turkish' else 'Mudanyali Multi-function App - English')
